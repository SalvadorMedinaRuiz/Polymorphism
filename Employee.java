...
public abstract class Employee
{
    ...
    */
    ...
    public boolean equals(Object otherObject)
	{
	    if (otherObject == null)
	        return false;
	    else if (getClass( ) != otherObject.getClass( )) //if otherObject is salaryemployee, this would be false bc salaryemployee is a subclass of employee, so they are both the same.
	        return false;
	    else
	    {
	        Employee otherEmployee = (Employee)otherObject; //explicit casting. refers to otherObject as an Employee class.
